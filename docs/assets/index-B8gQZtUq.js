 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,F){var z=L.length;L.push(F);e:for(;0<z;){var J=z-1>>>1,Q=L[J];if(0<r(Q,F))L[J]=F,L[z]=Q,z=J;else break e}}function n(L){return L.length===0?null:L[0]}function i(L){if(L.length===0)return null;var F=L[0],z=L.pop();if(z!==F){L[0]=z;e:for(var J=0,Q=L.length,se=Q>>>1;J<se;){var O=2*(J+1)-1,j=L[O],re=O+1,ge=L[re];if(0>r(j,z))re<Q&&0>r(ge,j)?(L[J]=ge,L[re]=z,J=re):(L[J]=j,L[O]=z,J=O);else if(re<Q&&0>r(ge,z))L[J]=ge,L[re]=z,J=re;else break e}}return F}function r(L,F){var z=L.sortIndex-F.sortIndex;return z!==0?z:L.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,d=null,h=3,p=!1,_=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(L){for(var F=n(u);F!==null;){if(F.callback===null)i(u);else if(F.startTime<=L)i(u),F.sortIndex=F.expirationTime,e(l,F);else break;F=n(u)}}function M(L){if(x=!1,g(L),!_)if(n(l)!==null)_=!0,B(R);else{var F=n(u);F!==null&&q(M,F.startTime-L)}}function R(L,F){_=!1,x&&(x=!1,c(b),b=-1),p=!0;var z=h;try{for(g(F),d=n(l);d!==null&&(!(d.expirationTime>F)||L&&!E());){var J=d.callback;if(typeof J=="function"){d.callback=null,h=d.priorityLevel;var Q=J(d.expirationTime<=F);F=t.unstable_now(),typeof Q=="function"?d.callback=Q:d===n(l)&&i(l),g(F)}else i(l);d=n(l)}if(d!==null)var se=!0;else{var O=n(u);O!==null&&q(M,O.startTime-F),se=!1}return se}finally{d=null,h=z,p=!1}}var A=!1,w=null,b=-1,Z=5,y=-1;function E(){return!(t.unstable_now()-y<Z)}function K(){if(w!==null){var L=t.unstable_now();y=L;var F=!0;try{F=w(!0,L)}finally{F?Y():(A=!1,w=null)}}else A=!1}var Y;if(typeof v=="function")Y=function(){v(K)};else if(typeof MessageChannel<"u"){var P=new MessageChannel,X=P.port2;P.port1.onmessage=K,Y=function(){X.postMessage(null)}}else Y=function(){m(K,0)};function B(L){w=L,A||(A=!0,Y())}function q(L,F){b=m(function(){L(t.unstable_now())},F)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,B(R))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(h){case 1:case 2:case 3:var F=3;break;default:F=h}var z=h;h=F;try{return L()}finally{h=z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,F){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var z=h;h=L;try{return F()}finally{h=z}},t.unstable_scheduleCallback=function(L,F,z){var J=t.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?J+z:J):z=J,L){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=z+Q,L={id:f++,callback:F,priorityLevel:L,startTime:z,expirationTime:Q,sortIndex:-1},z>J?(L.sortIndex=z,e(u,L),n(l)===null&&L===n(u)&&(x?(c(b),b=-1):x=!0,q(M,z-J))):(L.sortIndex=Q,e(l,L),_||p||(_=!0,B(R))),L},t.unstable_shouldYield=E,t.unstable_wrapCallback=function(L){var F=h;return function(){var z=h;h=F;try{return L.apply(this,arguments)}finally{h=z}}}})($p);jp.exports=$p;var e_=jp.exports;/**
 * @license React
...
`)+`
`+v);const M=g+c+o,R=g+v+a,A=wp(r,r.VERTEX_SHADER,M),w=wp(r,r.FRAGMENT_SHADER,R);r.attachShader(m,A),r.attachShader(m,w),n.index0AttributeName!==void 0?r.bindAttribLocation(m,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(m,0,"position"),r.linkProgram(m);function b(K){if(t.debug.checkShaderErrors){const Y=r.getProgramInfoLog(m).trim(),P=r.getShaderInfoLog(A).trim(),X=r.getShaderInfoLog(w).trim();let B=!0,q=!0;if(r.getProgramParameter(m,r.LINK_STATUS)===!1)if(B=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,m,A,w);else{const L=Ap(r,A,"vertex"),F=Ap(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(m,r.VALIDATE_STATUS)+`
